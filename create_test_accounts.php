...
echo "Login with any account using:\n";
echo "- Username: [first.last] (e.g., juan.delacruz)\n"; 
echo "- Password: password123\n";
echo "\nThen use the 'Send Money' feature to transfer between accounts!\n";